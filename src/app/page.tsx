...
export default function Home() {
  ...
  const bottomElementVariants: import("framer-motion").Variants = {
    hidden: { opacity: 0, y: 80 },
    visible: {
      opacity: 1,
      y: 0,
      transition: { type: "tween" as const, ease: "easeOut", duration: 0.8, delay: 0.2 },
    },
  };

  const pageTransitionVariants: import("framer-motion").Variants = {
