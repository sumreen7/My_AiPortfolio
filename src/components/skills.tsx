  ...
  const skillsData = [
    ...
    },
    {
      ...
      skills: [
        ...
        'Vercel AI SDK', 'Responsive Design', 'Progressive Web Apps',
      ],
    ...
    },
    {
      ...
      skills: [
        ...
        'BigQuery', 'Vector Databases', 'Weaviate', 'Pinecone',
      ],
    ...
    },
    {
      ...
      icon: <Cpu className="h-5 w-5" />,
      skills: [
        'LLM Fine-tuning', 'RAG', 'Agentic AI Modeling', 'Prompt Engineering',
        'Deep Learning', 'Neural Networks', 'TensorFlow', 'PyTorch',
        'Hugging Face', 'MLOps', 'AI Agents', 'Tool Calling',
      ],
    ...
    },
    {
      ...
      icon: <Cpu className="h-5 w-5" />,
      skills: [
        'Apache Spark', 'Pandas', 'NumPy', 'Apache Airflow', 'MLflow',
        'Jupyter', 'Tableau', 'PowerBI', 'Data Extraction', 'BS4', 'Selenium', 'Scrapy',
      ],
    ...
    },
    {
      ...
      skills: ['Figma', 'Canva', 'Keynote', 'UI/UX Design', 'Prototyping'],
    ...
    },
    {
      ...
      skills: [
        'Communication', 'Problem-Solving', 'Adaptability', 'Learning Agility',
        'Teamwork', 'Creativity', 'Focus', 'Project Management', 'Leadership',
      ],
